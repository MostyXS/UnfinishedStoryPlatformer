...
namespace Game.Menu.UI
{
    ...
    public class RebindActionUi : MonoBehaviour
    {
        ...
        /// </summary>
        public TextMeshProUGUI bindingTextMeshProUGUI
        {
            get => m_BindingText;
            set
            {
        ...
        /// replaced the <see cref="bindingTextMeshProUGUI"/> (if not <c>null</c>) with <c>"Waiting..."</c>.
        /// </remarks>
        /// <seealso cref="startRebindEvent"/>
        ...
        [Tooltip("TextMeshProUGUI label that will receive the current, formatted binding string.")] [SerializeField]
