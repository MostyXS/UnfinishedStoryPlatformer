...
namespace Game.Saving
{
    ...
    {
        [Tooltip("Changes the saveable state on current scene")] [SerializeField]
        string uniqueIdentifier = "";

        private Dictionary<string, SaveableEntity> _globalLookup = new Dictionary<string, SaveableEntity>();
